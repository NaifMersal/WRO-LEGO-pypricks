...
::: {.notes}
Act 3 of the turn-circle story: question → wheels answer → unroll the answer. Elicit the substitution, don't re-teach it — both ropes are Day-2 property: "what IS 13.04?" (360 ÷ 27.6) and "what was 27.6?" (3.14 × 8.8, the wheel's rope). The only NEW thing on this slide is the cancellation: same 3.14 on top and bottom → cancels; 360 ÷ 4 → 90. What's left is 90 × gap ÷ wheel: sanity-check on the calculator, 90 × 14.5 ÷ 8.8 = 148.3 ≈ their 148. The pocket line is a deliberate plant: **gap and wheel diameter are exactly the two numbers `DriveBase` asks for at the D8 reveal** — when that deck asks "why does it need the axle track?", call back to this cancellation. Land at least the final gap ÷ wheel line with everyone; if a squad is drowning in the algebra, the demo intuition carries the load — skim the middle steps and move on.
:::
